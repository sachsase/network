...
<h4>Groups &raquo; <?php echo $group_rec['group_name'];?> &raquo; Dashboard:</h4><br/>

<?php include_once("cdyn_includes/templates/group_links.php");?>

<?php

$sql="SELECT * FROM posts WHERE posts_owner=".$_SESSION[USR_SESSION]['members']['member_id']." AND group_id=".$group_rec['group_id']."  ORDER BY ABS(posts_id) DESC";
...
<p>No Post Here.<a href="create_group_post.php?grp=<?php echo $group_rec['group_id'];?>">Click here to add post</a></p>
