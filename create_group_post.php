...
<form class="cdynforms" name="cdynform" id="cdynform" action="create_group_post_action.php?grp=<?php echo $group_rec['group_id'];?>" method="post" enctype="multipart/form-data" >
...
<h4>Groups &raquo; <?php echo $group_rec['group_name'];?> &raquo; Create Post:</h4><br/>
