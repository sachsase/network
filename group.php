...
<h4>Groups &raquo; <?php echo $group_rec['group_name'];?>:</h4><br/>
...
$tr.='<tr><td>'.$i.'</td><td>'.$arr['group_name'].'</td><td>'.$CDYN_ARR['group_type'][$arr['group_type']].'</td><td><a href="group.php?grp='.$arr['group_id'].'">View</a></td></tr>';
$i++;
}
